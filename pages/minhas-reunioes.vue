...
const { connected: outlookConnected, deleteEvent: outlookDeleteEvent } = useOutlookCalendar()
...
const handleCancelMeeting = async (meetingId: string) => {
  ...
  if (outlookConnected.value && meeting?.outlook_event_id) {
    await outlookDeleteEvent(meeting.outlook_event_id)
  }
